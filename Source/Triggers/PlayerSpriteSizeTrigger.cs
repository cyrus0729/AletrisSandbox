...
static class EntitydataExtensions
{
...
public class PlayerSpriteSizeTrigger : Trigger
{
    ...
    public override void OnEnter(Player player) // start
    {
        ...
        originalsize = new(player.Sprite.Scale.X, player.Sprite.Scale.Y);
        player.Sprite.Scale = new(size.X, size.Y);
    }
    ...
    public override void OnLeave(Player player) // leave
    {
        ...
        player.Sprite.Scale = new(originalsize.X, originalsize.Y);
    }
