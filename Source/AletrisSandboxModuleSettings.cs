...
namespace Celeste.Mod.AletrisSandbox
{
    public class AletrisSandboxModuleSettings : EverestModuleSettings
    {
        ...
        {
            [SettingName("IWBTG Gun Enabled")] [SettingSubText("does not save")] [YamlIgnore]
            public bool IWBTGGunEnableOverride { get; set; } = false;
            [SettingName("IWBTG Gun Visible")] [SettingSubText("does not save")] [YamlIgnore]
            public bool IWBTGGunVisibleOverride { get; set; } = false;
