...
namespace Celeste.Mod.AletrisSandbox
{
    ...
    {
        public IWBTGMenu IWBTOptions { get; set; } = new IWBTGMenu();
        ...
        public MiscMenu MiscelleaneousMenu { get; set; } = new MiscMenu();
        ...
        public class IWBTGMenu
        {
            ...
            [SettingName("IWBTG Jump Enabled")]
            [SettingSubText("does not save")]
            [YamlIgnore]
        ...
        {
            [SettingName("Relativistic Velocity Enabled")]
            [SettingSubText("does not save")]
            [YamlIgnore]
