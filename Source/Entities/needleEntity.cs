...
[CustomEntity(
    "AletrisSandbox/NeedleUp = BigUp",
    "AletrisSandboxLite/NeedleUp = BigUp",
    "AletrisSandbox/NeedleDown = BigDown",
    "AletrisSandboxLite/NeedleDown = BigDown",
    "AletrisSandbox/NeedleLeft = BigLeft",
    "AletrisSandboxLite/NeedleLeft = BigLeft",
    "AletrisSandbox/NeedleRight = BigRight",
    "AletrisSandboxLite/NeedleRight = BigRight",
    "AletrisSandbox/MiniNeedleUp = MiniUp",
    "AletrisSandboxLite/MiniNeedleUp = MiniUp",
    "AletrisSandbox/MiniNeedleDown = MiniDown",
    "AletrisSandboxLite/MiniNeedleDown = MiniDown",
    "AletrisSandbox/MiniNeedleLeft = MiniLeft",
    "AletrisSandboxLite/MiniNeedleLeft = MiniLeft",
    "AletrisSandbox/MiniNeedleRight = MiniRight",
    "AletrisSandboxLite/MiniNeedleRight = MiniRight")]
public class NeedleEntity : Entity
{
    ...
    {
        var hitboxes = data.Enum("hitbox", HitboxType.NeedleHelper);

        switch (hitboxes)
        {
            default:
                return new NeedleEntity(
                    data,
                    offset,
                    new(new Hitbox(16f, 3f, -8f, -8f), new Hitbox(4f, 2f, -2f, 2f)),
                    GFX.SpriteBank.Create(data.Attr("Sprite", "NeedleEntity")),
                    0f);
        ...
        switch (hitboxes)
        {
            ...
            case HitboxType.NeedleHelper:
                return new NeedleEntity(
                    ...
                    GFX.SpriteBank.Create(data.Attr("Sprite", "MiniNeedleEntity")),
                    0f);
